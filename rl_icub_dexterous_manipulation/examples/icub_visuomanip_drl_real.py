...
import numpy as np
from rl_icub_dexterous_manipulation.envs.icub_visuomanip_refine_grasp_real import ICubEnvRefineGraspReal
...
iCub = ICubEnvRefineGraspReal(model_path=args.xml_model_path,
...
if args.train_with_residual_learning_pretrained_critic:
    ...
    print("train_with_residual_learning_pretrained_critics is False. Please set it to True to train the model.")
    quit()
